...
# Bot information
API_ID = environ.get('API_ID', '25953006')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'd5850aeef7dd3d01fe6b698c0a0d4be8') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '5673859971') #apni tg id daalo
if len(ADMINS) == 0:
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002148911492').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002150303936') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002387745957') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://omyogesh695:K3Q1OfKBd18Irux9@cluster0.8wwst.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #mongo db url
